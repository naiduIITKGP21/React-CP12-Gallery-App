...
class Gallery extends Component {
  ...
  render() {
    ...
    const {imageAltText, imageUrl} = imagesList[activeThumbnailId] // array index is same as id here

    return (
      <div className="app-container">
        <div className="gallery-container">
          <img className="selected-image" alt={imageAltText} src={imageUrl} />
          ...
          <ul className="thumbnails-list">
            {imagesList.map(eachObject => (
              <ThumbnailItem
                key={eachObject.id}
                isActive={activeThumbnailId === eachObject.id}
                details={eachObject}
